...
class FeatureHubRepositoryTest(unittest.TestCase):
    ...
    def test_notify_func_add_new_feature(self):
        ...
        self.assertEquals(feature.get_version, -1)
        ...
        self.assertEquals(feature.get_version, 2)
        self.assertEquals(feature.get_number, 123.78)
        ...
        self.assertEquals(feature.get_version, 3)
        self.assertEquals(feature.get_number, 128)
