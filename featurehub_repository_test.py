...
class FeatureHubRepositoryTest(unittest.TestCase):
    ...
    def test_notify_func(self):
        ...
        repo.notify('FEATURES',
                    [{'features': [{'id': '649b3792-1774-4bd5-b550-973ec6340531', 'key': 'FEATURE_TITLE_TO_UPPERCASE',
                                    'l': True, 'version': 1, 'type': 'BOOLEAN', 'value': False, 'strategies': []}]}])
        self.assertTrue(repo.ready)

        expected = FeatureStateBaseHolder(
            {'id': '649b3792-1774-4bd5-b550-973ec6340531', 'key': 'FEATURE_TITLE_TO_UPPERCASE',
             'l': True, 'version': 1, 'type': 'BOOLEAN', 'value': False, 'strategies': []}, )
