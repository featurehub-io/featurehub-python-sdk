...
from lib.featurehub_config import FeatureHubConfig
...
class FeatureHubConfigTest(unittest.TestCase):
    ...
    def test_featurehub_config_constructor(self):
        ...
        self.assertEqual(config._api_keys, [
            'default/29517115-da60-4b64-99db-9da017561edd/7NZq23UuFEdmpcwxx7lkKSH0QH1EIS*dmGCHaOErbXyMLfzHCe0'])
